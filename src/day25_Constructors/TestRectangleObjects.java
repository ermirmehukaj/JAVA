...
rectangle1.setInfo(3,4);
        ...
        rectangle4.setInfo(9,1);
        Rectangle rectangle5 = new Rectangle();
         rectangle5.setInfo(3,2);*/

Rectangle rectangle1 = new Rectangle(3,4);
Rectangle rectangle2 = new Rectangle(5,6);
Rectangle rectangle3 = new Rectangle(1,9);
Rectangle rectangle4 = new Rectangle(4,7);
Rectangle rectangle5 = new Rectangle(5,9);
